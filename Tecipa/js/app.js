...
const i18n = {
  pt: {
    ...
    ind_aviation_sub: "Tray mats & voos",
    ind_dining: "Restauração & Bares",
    ind_dining_sub: "Guardanapos & toalhetes",
    ind_hotel: "Hotelaria & Eventos",
    ind_hotel_sub: "Chemin de table & toalhas",
    ind_industry: "Indústria & Limpeza",
    ind_industry_sub: "Rolos de alta absorção",
    prod_type_title: "Tipo de Produto",
    p_napkins: "Guardanapos Personalizados",
    p_napkins_sub: "Textura linho & personalização",
    p_traymats: "Tray Mats (Aviação Civil)",
    p_traymats_sub: "Anti-deslizante e toque tecido",
    p_placemats: "Toalhetes Individuais / Chemin",
    p_placemats_sub: "Toalhetes e toalha de base",
    p_rolls: "Rolos Limpeza Industrial",
  ...
  en: {
    ...
    ind_aviation_sub: "Tray mats & flights",
    ind_dining: "Dining & Bars",
    ind_dining_sub: "Napkins & placemats",
    ind_hotel: "Hotels & Events",
    ind_hotel_sub: "Runners & tablecloths",
    ind_industry: "Industry & Cleaning",
    ind_industry_sub: "High absorption rolls",
    prod_type_title: "Product Type",
    p_napkins: "Custom Napkins",
    p_napkins_sub: "Linen texture & bespoke print",
    p_traymats: "Tray Mats (Civil Aviation)",
    p_traymats_sub: "Anti-slip & cloth-like feel",
    p_placemats: "Individual Placemats / Runners",
    p_placemats_sub: "Placemats & base tablecloths",
...
function initNavigation() {
  ...
  window.addEventListener('scroll', () => {
    if (window.scrollY > 20) {
      header.style.boxShadow = '0 4px 20px rgba(1, 2, 92, 0.08)';
    } else {
